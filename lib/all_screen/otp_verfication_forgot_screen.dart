...
class _Otp_Verfication_ForgotState extends State<Otp_Verfication_Forgot> {
                ...
                onTap: () {
                  ...
                  auth.signInWithCredential(_credential).then((result) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: const Text('Incorrent Otp'),behavior: SnackBarBehavior.floating, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),),
                    );
                    print(e);
                  });
                },
  ...
  Future<void> bootomshet(){
    return   Get.bottomSheet(isScrollControlled: true,Container(
      height: 250,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 15,),
            CommonTextfiled2(txt: 'Conform Password',controller: conformpasswordController,context: context),
            const SizedBox(height: 15,),
            InkWell(
                onTap: () {
                  ...
                  if(newpasswordController.text.compareTo(conformpasswordController.text) == 0){
                    ...
                    // ScaffoldMessenger.of(context).showSnackBar(
                    //   SnackBar(content: const Text('Please enter current password'),behavior: SnackBarBehavior.floating, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),),
                    // );
                  }

                },
                child: CommonButton(containcolore: const Color(0xff7D2AFF),txt1: 'Conform',context: context)),
          ],
        ),
      ),
    ));
