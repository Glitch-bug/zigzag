...
class _Top_upState extends State<Top_up> {
  ...
  //     'amount' : '${double.parse(walletController.text) * 100}',
  //     'name' : "${userData["name"]}",
  //     'description' : '',
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
          ...
          child: InkWell(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    if(payment == 3){
                                      ...
                                      // Fluttertoast.showToast(msg: 'Not Valid'.tr,timeInSecForIosWeb: 4);
                                    }
                                    if(payment == 4){
                                      Get.to(() => Flutterwave(
              ...
              child: CommonButton(containcolore:  const Color(0xff7D2AFF),txt2: 'Continue'.tr,context: context)),
        ),
      appBar: AppBar(
      ...
      body:  SingleChildScrollView(
        scrollDirection: Axis.vertical,
        child: isloading ? const Center(child: CircularProgressIndicator(color: Colors.red),) :  Column(
          ...
          children: [
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Text('${userData["name"]}',style: const TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16),),
            ...
            //               const CircleAvatar(radius: 35,backgroundColor: Color(0xff7D2AFF),child: Center(child: Icon(Icons.check,color: Colors.white,)),),
            //               const SizedBox(height: 20,),
            //               Text('Top up ${widget.searchbus}${walletController.text}.00',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
            //               const SizedBox(height: 5,),
            //               const Text('Successfuly',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
            //               const SizedBox(height: 30,),
            //               Text('${widget.searchbus}${walletController.text} has been added to your wallet',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.grey),),
            //               SizedBox(height: 30,),
            //               Padding(
            //                 padding: const EdgeInsets.only(left: 20,right: 20),
            //                 child: Row(
            ...
            //                     Expanded(
            //                       child: ElevatedButton(
            //                         style: ButtonStyle(fixedSize: MaterialStatePropertyAll(Size(0, 50)),backgroundColor: MaterialStatePropertyAll(Colors.white),side: MaterialStatePropertyAll(BorderSide(color: Colors.black)),shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(30))))),
            //                         onPressed: () {},
            ...
            //                     Expanded(
            //                       child: ElevatedButton(
            //                         style: ButtonStyle(fixedSize: MaterialStatePropertyAll(Size(0, 50)),backgroundColor: MaterialStatePropertyAll(Colors.black),side: MaterialStatePropertyAll(BorderSide(color: Colors.black)),shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(30))))),
            //                         onPressed: () {},
