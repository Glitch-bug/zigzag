                        ...
                        child: pw.Column(
                          children: [
                            pw.Padding(
                              ...
                              child: pw.Row(
                                children: [
                                  // pw. Image(image: AssetImage('assets/Rectangle_2.png'),height: 40),
    ...
    return  Scaffold(
      ...
      floatingActionButton: InkWell(
          ...
          child: Padding(
            ...
            child: CommonButton(containcolore: const Color(0xff7D2AFF),txt1:  'Download Ticket',context: context),
          )),
  body:
