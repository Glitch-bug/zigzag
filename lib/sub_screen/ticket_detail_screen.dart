    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          //                   Spacer(),
          //                   Text('1 Mayur',style: TextStyle(color: Colors.black),),
          //                   Spacer(),
          //                   Spacer(),
          //                   Spacer(),
          //                 ],
          ...
          //               Row(
          //                 children: [
          //                   Text('Ticket No',style: TextStyle(color: Colors.black),),
          //                   Spacer(),
          //                   Text('TSA290723220',style: TextStyle(color: Colors.black),),
          //                   Spacer(),
          //                   Spacer(),
          //                   Spacer(),
          //
          ...
          //               Row(
          //                 children: [
          //                   Text('Fare',style: TextStyle(color: Colors.black),),
          //                   Spacer(),
          //                   Text('     735.00',style: TextStyle(color: Colors.black),),
          //                   Spacer(),
          //                   Spacer(),
          //                   Spacer(),
          //                 ],
