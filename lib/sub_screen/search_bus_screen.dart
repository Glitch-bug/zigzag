...
class Search_Bus_Screen extends StatefulWidget {
 ...
 final String to;
 final String from;
 const Search_Bus_Screen({Key? key, required this.boarding_id, required this.drop_id, required this.trip_date, required this.to, required this.from}) : super(key: key);
                            ...
                            return  Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text('${data1?.reviewdata[index].userDesc}'),
                                ),
                    ...
                    child:  Padding(
                      ...
                      child: Column(
                        children: [
                          InkWell(
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) =>  Seat_Book_(boarding_id: widget.boarding_id,drop_id: widget.drop_id,currency: data.currency,differencePickDrop: data.busData[index].differencePickDrop,Difference_pick_drop: data.busData[index].differencePickDrop,totlSeat: data.busData[index].totlSeat,isSleeper: data.busData[index].isSleeper,busAc: data.busData[index].busAc,busRate: data.busData[index].busRate,busPicktime: data.busData[index].busPicktime,busDroptime: data.busData[index].busDroptime,ticketPrice: data.busData[index].ticketPrice.toString(),busImg: data.busData[index].busImg,id_pickup_drop: data.busData[index].idPickupDrop,busTitle: data.busData[index].busTitle,bus_id: data.busData[index].busId,trip_date: _selectedDate.toString(),uid: uid,boardingCity: data.busData[index].boardingCity,dropCity: data.busData[index].dropCity,from: widget.from,to: widget.to, ),));
                            },
                            child: Column(
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text('${data.currency}${data.busData[index].ticketPrice}',style:  const TextStyle(color: Color(0xff7D2AFF),fontSize: 15,fontWeight: FontWeight.bold),),
                                  ],
                                ),
                                const SizedBox(height: 15,),
                                Row(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(convertTimeTo12HourFormat(data.busData[index].busPicktime),style:  const TextStyle(fontWeight: FontWeight.bold,color: Color(0xff7D2AFF),fontSize: 12),overflow: TextOverflow.ellipsis),
                                            const SizedBox(height: 8,),
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 8,),
                                            Text(convertTimeTo12HourFormat(data.busData[index].busDroptime),style: const TextStyle(fontWeight: FontWeight.bold,color: Color(0xff7D2AFF),fontSize: 12),overflow: TextOverflow.ellipsis,),
                                            const SizedBox(height: 8,),
                                            Text(_selectedDate.toString().split(" ").first,style:  TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: notifier.textColor),overflow: TextOverflow.ellipsis),
                                            const SizedBox(height: 8,),
                                          ],
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(flex: 4,child: InkWell(
                                        ...
                                        child:  Text('Amenities'.tr,style: const TextStyle(color: Color(0xff7D2AFF),fontWeight: FontWeight.bold,fontSize: 12),))),
                                    Expanded(flex: 4,child: InkWell(
                                        onTap: () {
                                        ...
                                        child:  Padding(
                                          ...
                                          child:  Text('Review'.tr,style: const TextStyle(color: Color(0xff7D2AFF),fontWeight: FontWeight.bold,fontSize: 12),),
                                        ))),
                                    Expanded(flex: 4,child: InkWell(
                                        onTap: () {
                                          Get.bottomSheet(isScrollControlled: true,StatefulBuilder(
                                        ...
                                        child:  Text('Cancellation Policy'.tr,style: const TextStyle(color: Color(0xff7D2AFF),fontWeight: FontWeight.bold,fontSize: 12),))),
                                     // const Spacer(),
                                  ],
                                ),
                              ),
...
// children: [
//302298
// Text('From: ${data.busData[index].busTitle}',style: TextStyle(fontSize: 10),)
// ],
// ),